...
public class StopWordRemoval implements Serializable, TextFilter {
    private static final long serialVersionUID = 991746979701432820L;
    ...
    public StopWordRemoval makeCopy() {
        ...
        clone.stopWords.addAll(stopWords);
        return clone;
    }
    ...
    private boolean isIPAddress(String word){
        if(isValidInet4Address(word)){
            return true;
        } else return isValidInet4Address(word);
    }
